...
{
    public partial class addmigrationinitiate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Leveransadress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Telefonnummer = table.Column<long>(type: "bigint", nullable: false),
                    Postnummer = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KundModel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdrarId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
